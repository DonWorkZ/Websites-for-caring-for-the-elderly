...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST) && !empty($_POST)) {
	...
	if($valid){
				$sql="insert into contacts set first_name='$first_name',last_name='$last_name',email='$email',phone_number='$phone_number',message='$message'";
			...
			if (mysqli_query($conn, $sql)) {			
				...
				echo 'Contact Request Submitted';
			} 
			else {
