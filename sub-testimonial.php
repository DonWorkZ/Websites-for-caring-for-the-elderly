...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST) && !empty($_POST)) {
	...
	if($valid){
				$sql="insert into testimonials set f_name='$first_name',l_name='$last_name',email='$email',phone_no='$phone_number',date='$curTime',msg='$message'";
			...
			if (mysqli_query($conn, $sql)) {			
				...
				echo 'Testimonial Has Been Submitted';
			} 
			else {
