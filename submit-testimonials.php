                ...
                <div id="menu1" class="tab-pane fade active in">
                    <!-- <div class="row">
                        <div class="col-sm-12">
                            <div class="col-sm-7 service-left-img sc-content">
                                <img alt="" src="app-assets/img/testimonial_.jpg">
                            </div>
                            <div class="col-sm-5">
                    ...
                    <div class="row">
                        <div class="tabs-content-right sc-content sub-testimonial-sec-cls">
                            <div class="col-md-12">
                                <form action="sub-testimonial.php" method="POST" name="frm_req" id="frm_req_id">
    ...
    form.submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result === "Testimonial Has Been Submitted") {
