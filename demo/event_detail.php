  ...
  <tr>
    <td align="center" valign="top"><div align="center" style="padding-top:20px;">
      <table width="960" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="527" align="left" valign="top"><table width="95%" cellspacing="0" cellpadding="0">
              <tr>
              ...
              <tr>
                <td align="left"><div align="justify" style="padding-top:2px; line-height:22px;">
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td colspan="2" align="left"><?php echo $fet_row['description']; ?> </td>
                      </tr>
                    </table>
                  <?php
							}
          ...
          <td width="433" align="left" valign="top"><?php include("event-right.php"); ?></td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
        </tr>
