...
<title>Contact Us | St Joseph Manor Senior Assisted Living</title>
            ...
            <tr>
              ...
              <td class="text"><table width="100%" cellspacing="0" cellpadding="0">
               ...
               <!--  <tr>
                ...
                <tr>
                  <td height="19" colspan="2" align="left"><strong>Please enter the numbers and alphabets as you see them.</strong></td>
                </tr>
                <tr>
                  <td height="19" colspan="2" align="left">&nbsp;</td>
                </tr>
                <tr>
                  <td height="35" colspan="2" align="left"><table width="100%" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="10%"><span class="txt_label"><img src="captcha_code_file.php?rand=<?php echo rand(); ?>" name="captchaimg" align="right" id='captchaimg' /></span></td>
                      <td width="90%"><span class="txt_label">
                ...
                <tr>
                  <td height="35" colspan="2" align="left"><small style="font-size:15px;">Can't read the image? click <a href='javascript: refreshCaptcha();' style="color:#000">here</a> to refresh</small></td>
                </tr>
                <tr>
                  <td height="30" colspan="2" align="left">&nbsp;</td>
                </tr>
                <tr>
                  <td height="35" colspan="2" align="left"><ul class="but_bg_img" onClick="frm_submit();">
																	<li class="left">&nbsp;</li>
