...
<title>Amenities in Our Assisted Living Facility</title>

<meta name="description" content="Our assisted living facility has three acres of outdoors, a game room, parlor, another day parlor, a private chapel and so much more." />
...
<table width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" class="topinner"><table width="960" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td colspan="2" class="jquery3"><table width="960" cellspacing="0" cellpadding="0" height="350px;">
            <tr>
      ...
      <table width="960" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="651" align="left" valign="top"><table width="96%" cellspacing="0" cellpadding="0">
            <tr>
              <td height="52" align="left" class="title">Amenities</td>
            </tr>
            <tr>
              <td><img src="images/outdoor.jpg" width="622" height="357" /></td>
            </tr>
            <tr>
              <td><div align="justify">Three fenced acres of outdoor sun drenched walkways and a gazebo for warm and peaceful moments.<br />
                <br />
                <img src="images/game-room1.jpg" width="622" height="357" /><strong>Game Room -</strong> Enjoy a game of bingo, scrabble, cards, or watch T.V. on our big screen television, etc. Or just socialize with other residents about the days events.<br />
                <br />
              </div></td>
            </tr>
            
            <tr>
              <td><img src="images/parlor-room.jpg" width="622" height="357" /></td>
            </tr>
            <tr>
              <td><div align="justify"><strong>Parlor - </strong>Come sit, engage in conversation and pass the day away with your friends. Or just enjoy our beautiful atrium. <br />
                <br />
              </div></td>
            </tr>
            <tr>
              <td class="text"><img src="images/parlors.jpg" width="622" height="357" /></td>
            </tr>
            <tr>
              <td>Our day parlors are cozy and quiet for reading or just sitting with family or friends.<br />
                <br /></td>
            </tr>
            <tr>
              <td class="text"><img src="images/private-chapel.jpg" width="622" height="357" /></td>
            </tr>
            <tr>
              <td><strong>Private Chapel</strong> - Worship Services are conducted by various denominations.<br />
                <br /></td>
            </tr>
            <tr>
              <td><div align="justify"><img src="images/dining.jpg" width="622" height="357" /><br />
                  <strong>Dining in our spacious Dining Room</strong> - St. Joseph Manor graciously serves three delicious and nutritional meals daily in a spacious dining room. It's a great place to linger over coffee and discuss the day's events with friends and new acquaintances. <br />
  &bull;	Exercise - Stay fit by participating in out fitness program. <br />
  &bull;	Arts &amp; Craft Special Program - Discover your inner talent and interests by taking part in our recreational activities led by our Activities Coordinator. <br />
  &bull;	Movie Theater - Enjoy a movie and eat popcorn in our large screen theater.<br />
  <br />
              </div></td>
            </tr>
            <tr>
              <td class="text"><img src="images/aging-in-place.jpg" width="622" height="357" /></td>
            </tr>
            <tr>
              <td><div align="justify">St. Joseph Manor's &quot;Aging in Place&quot; philosophy allows many residents, especially those who make St. Joseph Manor their permanent home, to remain at St. Joseph Manor, even as their needs increase.</div></td>
            </tr>
          </table></td>
