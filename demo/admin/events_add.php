...
if($_POST['ins']!=""){
	...
	$result=mysql_query("insert into events set title='$title',event_date='$date',description='$description',active='$active',
	start_time='$st_time',end_time='$end_time',img_path='$save_img',img_label='$img_label',img_setting='$img_setting'");
...
<form controller="referFriends" id="ReferFriendIndexForm" method="post" action="events_add.php" enctype="multipart/form-data">	
