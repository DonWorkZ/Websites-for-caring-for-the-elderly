...
if($_POST['ins']!=""){
	...
	mysql_query("insert into blogs set title='$title',date='$date',description='$description',active='$active'");
...
<form controller="referFriends" id="ReferFriendIndexForm" method="post" action="blogs_add.php">	
