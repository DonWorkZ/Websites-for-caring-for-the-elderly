...
<title>Refer a friend | St Joseph Manor Senior Assisted Living</title>

<meta name="description" content="Tell us about a friend who needs senior assisted living care around Detroit Michigan" />
...
if($_POST['textfield3']!=""){
	...
	$sql=mysql_query("insert into refer_friends set first_name='$first_name',last_name='$last_name',email='$email',phone_number='$phone_number',message='$message'");
	...
	@mail($email, "ReferFriends Form", $message, $headers);
	
	echo "<script>window.location.href='refer-a-friend.php'</script>";
}
?>
...
<table width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" class="topinner"><table width="960" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td colspan="2" class="jquery4"><table width="960" cellspacing="0" cellpadding="0" height="350px;">
            <tr>
      ...
      <table width="960" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="651" align="left" valign="top"><table width="96%" cellspacing="0" cellpadding="0">
            <tr>
              <td height="45" align="left" class="title">Refer A Friend </td>
            </tr>
            <tr>
              <td><p>Thank you for your referral. Please provide your friend&rsquo;s  information below.</p>
                <p><br />
                  </p></td>
            </tr>
            <tr>
              <td class="text"><table width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="left"><strong> *&nbsp;First name (required): </strong></td>
                </tr>
                <tr>
                  <td align="left">
                    <label>
                ...
                <tr>
                  <td align="left"><strong> *&nbsp;Last name (required): </strong></td>
                </tr>
                <tr>
                  <td align="left"><input name="textfield2" id="textfield2" type="text" size="80" /></td>
                </tr>
                <tr>
                  <td align="left"><strong> *&nbsp;E-mail address (required): </strong></td>
                </tr>
                <tr>
                  <td align="left"><input name="textfield3" id="textfield3" type="text" size="80" /></td>
                </tr>
                <tr>
                  <td align="left"><strong> * Phone number (required):</strong></td>
                </tr>
                <tr>
                  <td align="left"><input name="textfield4" id="textfield4" type="text" size="80" /></td>
                </tr>
                <tr>
                  <td align="left"><strong> *&nbsp;Message (required): </strong></td>
                </tr>
                <tr>
                  <td align="left">
                    <label>
               ...
               <!--  <tr>
                ...
                <tr>
                  <td height="30" align="left"><strong>Please enter the numbers and alphabets as you see them.</strong></td>
                </tr>
                <tr>
                  <td height="30" align="left">&nbsp;</td>
                </tr>
                <tr>
                  <td height="35" align="left"><table width="100%" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="12%"><span class="txt_label"><img src="captcha_code_file.php?rand=<?php echo rand(); ?>" name="captchaimg" align="right" id='captchaimg' /></span></td>
                      <td width="88%"><span class="txt_label">
                ...
                <tr>
                  <td height="35" align="left"><small style="font-size:15px;">Can't read the image? click <a href='javascript: refreshCaptcha();' style="color:#000">here</a> to refresh</small></td>
                </tr>
                <tr>
                  <td height="35" align="left">&nbsp;</td>
                </tr>
                <tr>
                  <td height="35" align="left"><ul class="but_bg_img" onClick="frm_submit();">
																	<li class="left">&nbsp;</li>
