...
if($_POST['edit']>0){
	...
	mysql_query("update refer_friends set first_name='$first_name',last_name='$last_name',email='$email',phone_number='$phone_number',message='$message',is_agree='$is_agree' where id='$edit'");
	echo "<script>window.location.href='refer_friends.php?msg=yes';</script>";
}
?>
...
<?php
$sel=mysql_query("select * from refer_friends where id='$edit_id'");
...
<form controller="referFriends" id="ReferFriendIndexForm" method="post" action="refer_friends_edit.php">	
