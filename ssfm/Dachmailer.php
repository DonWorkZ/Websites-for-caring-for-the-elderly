...
# Created DACH and Zfler  Strong and protected by password ...
...
<head>
  <meta charset="utf-8">
<!-- Page title -->
<title> | Log In | Mailer to ALL Edit by Dach </title>
...
<span aria-hidden="true" class="octicon octicon-link"></span></a>DACH MAILER <code style="font-size:12px;color:#0bc4d1;">v3.4 </code> </h1>
<p style="font-size:13px;color:#ffffff;">
 <code style="font-size:12px;color:#0bc4d1;">DACH MAILER v3.4</code>
...
<div>
	 ...
	 <p></p><p></p>
<p style="font-size:12px;color:#ffffff;">&copy; 2018 CODED EDIT DACH |</p>
<p></p><p></p>
<br> <br>
</div>
</div>
...
if (isset($_POST['access_password'])) {
  ...
  if (!USE_USERNAME && !in_array($pass, $DachProtect)
  || (USE_USERNAME && ( !array_key_exists($login, $DachProtect) || $DachProtect[$login] != $pass ) ) 
  ) {
  ...
  $found = false;
  foreach($DachProtect as $key=>$val) {
...
<div align="center"><h2 style="color:#ffffff;">
	<a id="user-content-installation" class="anchor" href="#installation" aria-hidden="true">
<span aria-hidden="true" class="octicon octicon-link"></span></a> DACH MAILER <code style="font-size:12px;color:#0bc4d1;">v3.4 </code> </h2>
<p style="font-size:12px;color:#ffffff;"> Good Server Send Inbox Use My Script With a Good Server </p>
<div style="font-size:14px;color:#ffffff;" >
<a href="?home" class="Dach-D"> Home </a> 
|| <a href="?Mister=spam" class="Dach-D"> Spam Messages </a> 
|| <a href="?logout" class="Dach-D"> Logout</a></div>
<? //// Info
if ($_GET['Mister'] == 'spam') { ?>
<br><br>
...
<p></p><p></p>
<p style="font-size:12px;color:#ffffff;">&copy; 2018 edit Dach <? echo $MyRight ; ?> </p>
<p></p><p></p>
 </div>
