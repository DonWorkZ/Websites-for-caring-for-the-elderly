      ...
      <table width="960" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="651" align="left" valign="top">
			  ...
			  <tr>
				<td height="55" align="left" class="title">Blogs</td>
			  </tr>
			 <tr>
				  <td align="left"><div align="justify" style="padding-top:2px; line-height:22px;">
						...
						if($whr_dat<>""){
							$sql_get="select * from blogs where active='1' $whr_dat order by id desc";
						...
						if($chk_whr_num==0){
							$sql_get1="select date from blogs where active='1' order by date desc";
							...
							$sql_get="select * from blogs where active='1' order by id desc";
							$sql_qry=mysql_query($sql_get);
							$chk_whr_num=mysql_num_rows($sql_qry);
						}
								...
								<table cellpadding="10" cellspacing="0" width="100%">
									<tr>
										<td align="left" class="bottom_text">
											<strong><?php echo $fet_row['title']; ?></strong>
										</td>
									</tr>
									<tr>
										<td  class="txt_label" align="justify">
											<?php 
											$dat_exp=explode('-',$fet_row['date']);
											$final_dat=date('m/d/Y',mktime(0,0,0,$dat_exp[1],$dat_exp[2],$dat_exp[0]));
												echo $final_dat; 
									...
									<tr>
										<td align="left" class="txt_label" style="line-height:22px;">
											<?php echo $fet_row['description']; ?>
