...
if($fname<>"" && $final_phone<>""){
	...
	$sql="insert into call_you set first_name='$fname',last_name='$lname',time_frm='$time_frm',
	...
	echo "<script>alert('Thankyou for your online call request!');location.href='index.php';</script>";
